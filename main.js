...
const traffic=[
    ...
    new Car(road.getLaneCenter(1),-700,30,50,"DUMMY",3.3,getRandomColor()),
    new Car(road.getLaneCenter(2),-900,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(1),-100,30,50,"DUMMY",6,getRandomColor()),
    new Car(road.getLaneCenter(0),-400,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(2),-500,30,50,"DUMMY",1,getRandomColor()),
    new Car(road.getLaneCenter(0),-5000,30,50,"DUMMY",2,getRandomColor()),
